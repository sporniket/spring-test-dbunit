...
public class FlatXmlDataSetLoader extends AbstractDataSetLoader {
    ...
    private boolean columnSensingEnabled = true ;

    @Override
    protected IDataSet createDataSet(Resource resource) throws DataSetException, IOException {
        final FlatXmlDataSetBuilder builder = new FlatXmlDataSetBuilder() ;
        builder.setColumnSensing(isColumnSensingEnabled()) ;
        return buildDataSet(builder, resource) ;
    }

    private IDataSet buildDataSet(FlatXmlDataSetBuilder builder, Resource resource) throws DataSetException, IOException {
        try {
    ...
    private IDataSet buildDataSetFromStream(FlatXmlDataSetBuilder builder, Resource resource) throws IOException, DataSetException {
    ...
    public boolean isColumnSensingEnabled() {
        return columnSensingEnabled ;
    }

    public void setColumnSensingEnabled(boolean columnSensingEnabled) {
        this.columnSensingEnabled = columnSensingEnabled ;
    }
